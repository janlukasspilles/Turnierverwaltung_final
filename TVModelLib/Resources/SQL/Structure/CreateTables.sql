...
--
-- Tabellenstruktur für Tabelle BENUTZERRECHT
--
CREATE TABLE BENUTZERRECHT (
  ID int(11) NOT NULL,
  BEZEICHNUNG varchar(50) NOT NULL
);
...
--
-- Tabellenstruktur für Tabelle BENUTZERROLLE_BENUTZERRECHT
--
CREATE TABLE BENUTZERROLLE_BENUTZERRECHT (
  ID int(11) NOT NULL,
  BENUTZERROLLE_ID int(11) NOT NULL,
  BENUTZERRECHT_ID INT(11) NOT NULL
);
...
--
-- Indizes für die Tabelle BENUTZERRECHT
--
ALTER TABLE BENUTZERRECHT
  ADD PRIMARY KEY (ID);

--
-- Indizes für die Tabelle BENUTZERROLLE_BENUTZERRECHT
--
ALTER TABLE BENUTZERROLLE_BENUTZERRECHT
  ADD PRIMARY KEY (ID),
  ADD KEY BENUTZERROLLE_ID (BENUTZERROLLE_ID),
  ADD KEY BENUTZERRECHT_ID (BENUTZERRECHT_ID);
...
--
-- AUTO_INCREMENT für Tabelle BENUTZERRECHT
--
ALTER TABLE BENUTZERRECHT
  MODIFY ID int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle BENUTZERROLLE_BENUTZERRECHT
--
ALTER TABLE BENUTZERROLLE_BENUTZERRECHT
  MODIFY ID int(11) NOT NULL AUTO_INCREMENT;
...
--
-- Constraints der Tabelle BENUTZERROLLE_BENUTZERRECHT
--
ALTER TABLE BENUTZERROLLE_BENUTZERRECHT
  ADD CONSTRAINT FK_ROLLE FOREIGN KEY (BENUTZERROLLE_ID) REFERENCES BENUTZERROLLE (ID) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT FK_RECHT FOREIGN KEY (BENUTZERRECHT_ID) REFERENCES BENUTZERRECHT (ID) ON DELETE CASCADE ON UPDATE CASCADE;
